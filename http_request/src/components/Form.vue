...
onMounted(async () => {
  ...
  try {
    const response = await axios.get('https://vue-example-9c3ab-default-rtdb.firebaseio.com/surveys.json')
...
const onSubmit = (e: Event) => {
  // fetch('https://vue-example-e0cb8-default-rtdb.firebaseio.com/surveys.json', {
  //   method: 'POST',
  //   headers: {
  ...
  // }
  // )
  axios.post('https://vue-example-9c3ab-default-rtdb.firebaseio.com/surveys.json', {
    name: userName.value,
